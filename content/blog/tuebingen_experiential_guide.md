...
I'm a great fan of live sports and sports events, so those represented a major part of my budget allocation. Unfortunately, I wasn't able to attend some events, such as, for example, the [Chocolart](https://www.chocolart.de/), which was suspended in 2021 due to Covid limitations.

### Tübingen Tigers

I really like basketball and I was very happy when I discovered Tübingen had a basketball team, the Tigers. The [Tübingen Tigers](https://tigers-tuebingen.de/) play in the German second league and, differently from what one might think, the atmosphere in the building was amazing! 
...
When I discovered there was a [tennis tournament in Stuttgart](https://www.atptour.com/en/tournaments/stuttgart/321/overview), I've been torn for a few hours while deciding if I wanted to go or not. In the end, I was quite happy with my choice of going to see the quarter-finals, even if the price for those four matches was close to 80 euros.
...
On the other side, I suggest you avoiding to insert in your everyday life places like [Gasthausbrauerei Neckarmüller](https://goo.gl/maps/uvpkuUCNMAGziHhU8). While this is a pretty typical touristic choice because of its location, immediately close to the [Neckarbrücke](https://goo.gl/maps/32r1Vc31LEdxCxgF6), service is terrible (a characteristic that it shares with many other German restaurants) and the quality level is quite random. My suggestion is to go there rarely and just have a beer and a [Flammkuchen](https://en.wikipedia.org/wiki/Flammekueche), avoiding a complete meal.
...
I probably never felt so well integrated into the local culture as when I tried the [Landgasthaus Waldhäuser Hof](https://waldhaeuser-hof.de/). The food was good, but the setting is probably even better, just in the middle of the Waldhäuser farms area. And, in fact, the location is probably the main highlight of this place!
...
[Saints & Scholars](https://www.saints-and-scholars.de/) is an Irish pub in a very convenient location. Being so close to the main library, it has always been a valid alternative to the University canteen. 
...
In case you just wanted to have a quick Pita, just outside the restaurant, there is the [Yellow Donkey](https://goo.gl/maps/XuMV1g99AGbPXNeP7), a fast food and take-away stand, with a lean menu.

Meal price: 30-35 euros. Here there are the [Google Maps location](https://goo.gl/maps/rbuvqqHf5cm57Adv8) and their [Tripadvisor page](https://www.tripadvisor.it/Restaurant_Review-g198539-d19142126-Reviews-Faros_an_ouzo_philosophy-Tubingen_Baden_Wurttemberg.html?m=19905).
...
Meal price: 8-10 euros. Here there are the [Google Maps location](https://goo.gl/maps/GFq7XpbsMPiyhkwn9) and their [Tripadvisor page](https://www.tripadvisor.it/Restaurant_Review-g198539-d1343251-Reviews-Kichererbse-Tubingen_Baden_Wurttemberg.html?m=19905).
...
Meal price: 8-10 euros. Here there is the [Google Maps location](https://goo.gl/maps/JMjrF4DbxCoAicBh9).

### Chinese: China Restaurant San Bao

While the [San Bao](https://sites.google.com/view/sanbao-tuebingen/home) is actually a restaurant, with table service, I mostly got take-away food from there. I liked the noodles, which were a valid alternative to the always-present kebab for those dinners in the library. Close to San Bao, there is also [Hao's Box](https://goo.gl/maps/vQzMZBVCo6KbcKDa7): these two places are both good and almost exchangeable for me...

Take-away meal price: 8-12 euros. Here there are the [Google Maps location](https://goo.gl/maps/w5FR1eZnjybf3yxH9) and their [Tripadvisor page](https://www.tripadvisor.it/Restaurant_Review-g198539-d21333417-Reviews-San_Bao-Tubingen_Baden_Wurttemberg.html).
...
Here there is the [Google Maps location](https://goo.gl/maps/35yLStsTYQt68JZH7).
